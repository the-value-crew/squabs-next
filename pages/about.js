  ...
  return (
    <>
      <Head>
        ...
        />
        <meta name="keywords" content="squabs, squabsnyc" />
      ...
      <div className="bg-brand-gray-dark">
        ...
        <section className="mt-12 container text-white text-lg text-center">
          <div className="w-3/2">
            <p>
              Squabs is an uplifting animated series that provides an
              encouraging message that we all need to hear.
            </p>
                    ...
                    <div className="flex items-center space-x-2 md:space-x-4">
                      ...
                      <div>
                        <p className="lg:text-lg xl:text-xl">
                          ...
                          showcase the power of genuine friendship, and a
                ...
                <div className="mt-12 pt-28 md:pt-32 about-solutions-bg">
                  <div className="relative flex flex-col space-y-10">
                    <div className="flex items-center space-x-2 md:space-x-4">
                      ...
                      <div>
                        <p className="lg:text-lg xl:text-xl">
                          We encoure youth, through a sharp, intelligent
                          animated series, to pursue their own image of success
                          by embracing their unique bundle of artsy, brainy, and
                    ...
                    <div className="flex items-center space-x-2 md:space-x-4">
                      ...
                      <div>
                        <p className="lg:text-lg xl:text-xl">
                          ...
                          thoughtful dialouge demonstrating to viewers that it
                          is OK to be YOU, and that everyone is welcome.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-2 md:space-x-4">
                      ...
                      <div>
                        <p className="lg:text-lg xl:text-xl">
                          Through vibrant, graffiti-like imagery, we emphasize
                          the value of geniune friendship, becoming wise through
            ...
            <div className="swiper-wrapper">
              ...
              <SwiperSlide>
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-4 text-xl">
                    <p>
                      Socially awkward, and his artsy insight is a source of
                      comic relief.
                    </p>
                  </div>
                </div>
              ...
              <SwiperSlide>
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-4 text-xl">
                    <p>
                      Carefree and his lighthearted commentary eases tension
                    </p>
                  </div>
                </div>
              </SwiperSlide>
                ...
                <div className="blue-bleeding-bg our-audience-body mt-8">
                  <ul className="text-white list-disc">
                    ...
                    <li className="lg:text-lg xl:text-xl">
                      Young people who don&apos;t fit in, and deal with
                      obstacles that seem too big to overcome.
                    </li>
                    <li className="lg:text-lg xl:text-xl">
            ...
            <div className="mt-24 md:mt-0 md:w-1/2 md:flex items-center">
              <div className="lg:text-lg xl:text-xl lg:pt-12 xl:pt-24 purple-bleeding-bg goal-body">
                <div className="flex items-center space-x-2 md:space-x-4">
                  ...
                  <div>
                    <p>
                      Squabs is looking for a production investment to create
                      its first two seasons in the entirety.
                    </p>
                  </div>
                </div>
